  ...
  const contactInfo = [
    {
      icon: Mail,
      title: "Email",
      value: "palanisamy.dev@gmail.com",
      href: "mailto:palanisamy.dev@gmail.com"
    },
    {
      icon: Phone,
      title: "Phone",
      ...
      >
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <motion.div variants={itemVariants} className="space-y-8">
              ...
              <div className="space-y-6">
                {contactInfo.map((info, index) => (
                  <motion.a
                    ...
                    href={info.href}
                    whileHover={{ x: 10 }}
                    className="flex items-center space-x-4 p-4 glass-effect rounded-xl hover:bg-primary-50 transition-all duration-300 group"
                  >
            ...
            {/* Social Links */}
            <div>
              <h3 className="text-2xl font-bold text-dark-800 mb-6">Follow Me</h3>
              <div className="flex space-x-4">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.9 }}
                    className="w-12 h-12 bg-primary-100 rounded-lg flex items-center justify-center text-primary-600 hover:bg-primary-200 transition-all duration-300"
            ...
            >
              <h3 className="text-xl font-bold text-dark-800 mb-4">Availability</h3>
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  <div className="w-3 h-3 bg-green-500 rounded-full animate-pulse"></div>
                  <span className="text-dark-600">Available for new projects</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-3 h-3 bg-blue-500 rounded-full"></div>
                  <span className="text-dark-600">Response time: Within 24 hours</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-3 h-3 bg-purple-500 rounded-full"></div>
                  <span className="text-dark-600">Timezone: IST (GMT+5:30)</span>
                </div>
              </div>
            </motion.div>
          </motion.div>
          ...
          <motion.div variants={itemVariants}>
            <div className="glass-effect p-8 rounded-2xl">
              <h3 className="text-2xl font-bold text-dark-800 mb-6">Send Me a Message</h3>
